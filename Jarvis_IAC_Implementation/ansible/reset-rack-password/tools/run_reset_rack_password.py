        ...
        print_result(
            {
                ...
                "messages": ["The endpoint's desired credential already works for the Cisco CIMC Redfish account."],
        ...
        print_result(
            {
                ...
                "messages": ["The endpoint's manufacturing credential could not read the Cisco CIMC Redfish account resource."],
                "desired_precheck_status": desired_status,
                "desired_precheck_error": desired_error,
        ...
        print_result(
            {
                ...
                "messages": ["The endpoint's Cisco CIMC Redfish service did not report PasswordChangeRequired for the manufacturing credential."],
                "redfish_root_vendor": redfish_root_vendor,
                "redfish_root_product": redfish_root_product,
            }
        )
        ...
        print_result(
            {
                ...
                "messages": [patch_error or f"Unexpected Cisco CIMC Redfish patch status {patch_status}"],
                "redfish_root_vendor": redfish_root_vendor,
                "redfish_root_product": redfish_root_product,
            }
        )
